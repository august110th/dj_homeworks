...
from measurement.views import SensorInfoView, MeasurementsView, SensorView, MeasurementsDataView, SensorCreate
...
urlpatterns = [
    ...
    path('measurement/<pk>/', MeasurementsDataView.as_view()),
